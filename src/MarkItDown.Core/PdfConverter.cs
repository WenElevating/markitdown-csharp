...
public sealed class PdfConverter : IConverter
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            if (totalLetters < 20)
            {
                throw new ConversionException(
                    ConversionErrorCode.UnsupportedContent,
            ...
            return Task.FromResult(new DocumentConversionResult(DocumentKind.Pdf, markdown));
        }
        ...
        {
            throw new ConversionException(ConversionErrorCode.ConversionFailed, "Failed to convert PDF to Markdown.", ex);
        }
    }
